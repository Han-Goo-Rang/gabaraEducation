<x-app-layout :title="$news->title">
    <article class="col-span-4 md:col-span-3 mt-10 mx-auto py-5 px-4 md:px-6 w-full" style="max-width:700px">
        <img class="w-full my-2 rounded-lg" src="{{ $news->getThumbnailUrl() }}" alt="thumbnail">
        ...
        <div class="mt-2 flex justify-between items-center">
            <div class="flex py-5 text-base items-center">
                ...
                <span class="text-gray-500 text-sm">| {{ $news->getReadingTime() }} min read</span>
            </div>
